...
document.getElementById("collegeno").onclick = function() {
    ...
    button1.onclick = function(){
        ...
        button3.onclick = function(){ 
            ...
            window.open("https://aissmsioit.org/admission/admission-form/")
         }
        ...
        button4.onclick = function() { 
            ...
            message.append(text)
            window.open("https://aissmsioit.org/admission/fee-structure/")
        ...
        button5.onclick = function() { 
            ...
            window.open("https://aissmsioit.org/admission/procedure/")
        ...
        button6.onclick = function() {
            ...
            message.append(text)
            window.open("https://aissmsioit.org/wp-content/uploads/2022/10/Leaflate-2022.pdf")
        }
